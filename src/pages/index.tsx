  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Simplifying your HR processes, empowering your team, and transforming the way you manage talent."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Simplifying your HR processes, empowering your team, and transforming the way you manage talent.`}
            </Text>
            <Box
